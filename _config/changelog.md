...
- 2026-06-14 — Progress bar do Lote 01 subiu de 22% pra 93% (Hero ticker + label + fill, Pricing label + fill). Sync global em todas as 7 versões ativas (v3/v4/v5/v6/v7/v8/v9) — pressão de escassez pra fechar Lote 01.
