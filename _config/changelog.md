...
**Refinamentos:**
- 2026-05-11 — Barra de progresso do Lote 01 no Hero subiu de 42% pra 77% (label "77% vendidos", fill visual `width: 77%` e item do ticker marquee). Espelha o ajuste feito na v4 — sincroniza a página de prod (`/`) com a escassez real do lote.
